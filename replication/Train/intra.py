...
#rain_samples=np.concatenate([train_samples,labels_train],axis=-1)#这个是没用上下采样的

trainData='traininner.csv'
testData ='testinner.csv'
...
#autogluon
label_column = 'test'
dir = 'agModels-predictClass_TEST'
...
recommendation_path = '../dataset/resultsTEST'
